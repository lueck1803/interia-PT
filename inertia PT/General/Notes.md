...
+⃞ ⃞ ⃞|◣ ⃝ ⃞ ⃝◢ ⃞ ⃞  ⃞  ⃞  ⃞ | ◣ ⃝ ⃞+~={Gold}17=~
 +⃞ ⃞  ⃝◢ ⃞ ⃞ ⃞  ⃞ |⃝ ⃞ ⃞ ⃞ ⃝◢  ⃞ ⃞ ⃞ ◣ | ⃝ ⃞ ⃞+~={DeepPink}15=~
 +⃞  ⃝◢ ⃞ ⃞ ⃞  ⃞ ⃞ | ◣ ⃝ ⃞ ⃝◢ ⃞ ⃞ ⃞  ⃞ ⃞ | ◣ ⃝ ⃞+~={Teal}13=~
 +⃞ ⃞ ⃞  ⃞ ⃞ ⃞ ⃞ ⃞ |  ⃞ ⃞ ⃞ ⃞ ⃞  ⃞ ⃞ ⃞ ⃞ ⃞ | ⃞ ⃞ ⃞+ ~={Tomato}11=~
 +⃞ ⃞ ⃞  ◣ ⃝ ⃞ ⃝◢  |  ⃞ ⃞ ⃞ ⃞ ⃞ ◣ ⃝ ⃞ ⃝◢  | ⃞ ⃞ ⃞+ ~={DarkViolet}9=~
 +⃞ ⃞ ⃞  ◣ ⃝ ⃞ ⃝◢  |  ⃞ ⃞ ⃞ ⃞ ⃞ ◣ ⃝ ⃞ ⃝◢  | ⃞ ⃞ ⃞+ ~={pink}7=~
 +⃞ ⃞ ◣ ⃝ ⃞ ⃞ ⃞ ⃝ | ◢ ⃞ ⃞ ⃞  ◣ ⃝ ⃞ ⃞ ⃞ ⃝|◢  ⃞ ⃞+ ~={MediumSpringGreen}5=~
 +⃞ ⃞ ⃞ ◣ ⃝ ⃞ ⃝◢  |  ⃞ ⃞ ⃞ ⃞ ⃞ ◣ ⃝ ⃞ ⃝◢ | ⃞ ⃞ ⃞+ ~={blue}3=~
