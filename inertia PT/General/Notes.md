...
### P - pre trained
Refers to how the model went through a process of learning from a massive amount of data and the prefix insinuates that there is more room to fine-tune it on specific tasks with 
### T - transformer 
## loss function
