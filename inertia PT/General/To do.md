...
- Körperpflege 
- frische Luft %% fold %%
- mich und mein Leben im Griff haben %% fold %%
 %% fold %%
## japanische 1-Minutenregel %% fold %%
### 1 - Kaizen %% fold %%
...
- finde eine <font color="#00b050">kleinste Version</font> davon, so klein dass du schon <font color="#ffff00">fast lachen</font> musst. %% fold %%
...
- [ ] Physik 8 Arbeitsblatt D) da ist ein "um"  zu viel
...
- [ ] English 5b %% fold %%
	...
	- **Fragen (Questions)** %% fold %%
	  Bei Fragen mit den meisten Verben brauchst du ein Hilfsverb wie do oder did an den Anfang: %% fold %%
...
Es ist offenbar auch egal ob man <font color="#a0522d">titan ridge</font> oder <font color="#800000">maple ridge</font> wählt, geht beim start unter Umständen mit beiden. ⟹ im <font color="#92cddc">device manager</font> wird dennoch <font color="#fac08f">nichts angezeigt</font>
Mit Titan ridge wird aber beim herunterfahren länger etwas angezeigt. Dafür erscheint nach Neustart nichts.
...
- [ ] Firmware troubleshooting 
	...
	- [ ]  Firmware install troubleshooting 
		- [ ] was bedeuten die infos bei der Anzeige?
		- [ ] Firmware neu auf usb Stick 
		...
		- br 1:10
			- 14k 
				- PE 35
					...
					- M 0.060 <font color="#ff0000">cluster</font> <font color="#92d050">fertig</font> <font color="#c815ff">snapshots</font>
					...
					- M 0.085 <font color="#ff0000">cluster</font> ✅
					- M 0.088 <font color="#ff0000">cluster</font> ✅
				...
				- PE 45
					...
					- M 0.020 <font color="#ff0000">cluster</font> ✅
					- M 0.030 <font color="#ff0000">cluster</font>✅
					- M 0.040 <font color="#ff0000">cluster</font> ✅
					- M 0.050 <font color="#ff0000">cluster</font> ✅
					- M 0.060 <font color="#ff0000">cluster</font> ✅
					- M 0.070 <font color="#ff0000">cluster</font>  ✅				
					- M 0.080 <font color="#ff0000">cluster</font> ✅☑
					- M 0.090 <font color="#ff0000">cluster</font> ✅			
					- M 0.085 <font color="#ff0000">cluster</font> ✅
					- M 0.088 <font color="#ff0000">cluster</font> ✅
					- M 0.100 <font color="#ff0000">cluster</font> ✅☑
					- M 0.110 <font color="#ff0000">cluster</font> ✅
		...
		- br 1:3
			- 14k 
				- PE 35
					...
					- M 0.040 <font color="#ff0000">cluster</font> <font color="#92d050">fertig</font> <font color="#c815ff">snapshots</font>
...
- [ ] Email von letzter Woche an Arooj schreiben  %% fold %%
	...
	- Arooj schreiben insbesondere wegen Elias Gudwis <font color="#7cfc00">Selbstbefreiung</font> <br> Stichworte:
		...
		- dafür bedanken dass sie mir auch immer den Spiegel vorgehalten und mir so mit Wachstum ermöglicht hat. 
...
- [ ] Wechselkleidung
	- [ ] t-shirt
	- [ ] unterhemd
	- [x] wacken regen poncho
		- ne es regnet garantiert nicht
- [ ] Bananen
- [ ] Fernglas? Hmm ne ist zu schwer
	- [x] vorher ein neues kompaktes kaufen? 
	- [ ] hab ich jetzt nicht gekauft
- [ ] Sonnencreme
- [ ] Hut
- [ ] Sonnenbrille
