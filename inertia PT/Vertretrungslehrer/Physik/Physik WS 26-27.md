...
## 2026-08-17
- [ ] Einheiten umrechnen? ⟹ da ich die nicht in Mathe habe
...
- Einheitenumrechnung:
	...
	- Wie rechnet man Einheiten um? Hier der universale Trick, den wir mehrfach üben werden (Beispiel):
	- Rechne 64 cm in inch (deutsches Wort: Zoll)
...
- Folglich ist der Druck des Fluids direkt proportional zu der Dichte der Flüssigkeit und zu der Eintauchtiefe in der Flüssigkeit
...
- Geschwindigkeit als Vektor:
	...
	- Bei der Beschreibung von physikalischen Problem ist es sinnvoll Geschwindigkeiten zu einem 
		...
		- ⤷ Warum? Da man die verschiedenen Richtungen x und y oder entlang des Radius oder tangential zur Kreisbewegung, separat betrachten kann %% fold %%
